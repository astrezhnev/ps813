...
- So far, we've shown that the OLS estimator is consistent and asymptotically normal for the **Best Linear Predictor**
  ...
  - In non-experimental settings, we often **do** need to get this correct (next week - regression adjustment for confounders!)
...
- All we need is an estimator for $\sigma^2$ 
  ...
  - Can do better by including a "degrees of freedom" correction
