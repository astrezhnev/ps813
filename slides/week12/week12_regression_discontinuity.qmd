---
title: "Week 12: Regression Discontinuity Designs"
...
## Regression Discontinuity Designs {.title-slide}
...
- We can therefore identify the treatment effect **at the threshold** using the difference in the one-sided limits
  ...
  $$\begin{align*}\tau_{\text{SRD}} &= \mathbb{E}[Y_i(1) - Y_i(0) | X_i = c]\\
  &= \mathbb{E}[Y_i(1) | X_i = c] - \mathbb{E}[Y_i(0) | X_i = c]\\
  &= \lim_{x \to c^{+}} \mathbb{E}[Y_i | X_i = x] - \lim_{x \to c^{-}} \mathbb{E}[Y_i | X_i = x]
  \end{align*}$$
...
![](assets/imbens_lemieux.png){fig-align="center" height="500px"}

## Visualizing the sharp RD

![](assets/cattaneo_example_1.png){fig-align="center" height="500px"}
...
![](assets/cattaneo_example_2.png){fig-align="center" height="400px"}
...
](assets/nber_bunching.jpg){fig-align="center" height="500px"}


## Estimation: Local Regression {.title-slide}
...
![](assets/cattaneo_kernel.png){fig-align="center" height="500px"}
...
![](assets/pnas_distribution.jpeg){fig-align="center" height="300px"}

## Discussion: Higher-order polynomials

- They estimate the effect using a global third-order polynomial of distance to the Huai river

![](assets/pnas_reduced_form.jpeg){fig-align="center" height="450px"}

## Discussion: Higher-order polynomials

![](assets/pnas_first_stage.jpeg){fig-align="center" height="500px"}
...
![](assets/fuzzy_rd_pscore.png){fig-align="center" height="500px"}
...
- Second stage
  ...
  $$Y_i = \beta_0 + \tau \tilde{D_i} + \beta_1(X_i - c) + \beta_2(X_i - c)\mathbb{1}(X_i \ge c)$$
...
![](assets/bleemer_first_stage.png){fig-align="center" height="500px"}

## Example: Majoring in Economics

- The reduced form is a sharp RD

![](assets/bleemer_reduced_form.png){fig-align="center" height="500px"}

## Example: Majoring in Economics

![](assets/bleemer_industry_effects.png){fig-align="center" height="500px"}

## Diagnosing assumptions {.title-slide}
...
![](assets/bleemer_balance.png){fig-align="center" height="500px"}
